...
1. Create and merge a pull request that:
    - increases the version number in
      [`python/__version__.py`](https://github.com/xainag/xain/blob/master/python/__version__.py)
      according the versioning schema.
    - updates the
      [`CHANGELOG.md`](https://github.com/xainag/xain-proto/blob/master/CHANGELOG.md)
      with all notable changes for the release.
    - possibly update the `Development Status` classifiers in the
      [`setup.py`](https://github.com/xainag/xain-proto/blob/master/python/setup.py). You
      can check supported classifiers in the [pypi
      website](https://pypi.org/classifiers/).
2. Got to the [Github Releases tab](https://github.com/xainag/xain-proto/releases)
